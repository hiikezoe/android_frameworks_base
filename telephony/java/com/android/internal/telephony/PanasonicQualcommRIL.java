...
/**
 * RIL class for Panasonic P-01D
 *
 * {@hide}
 */
public class PanasonicQualcommRIL extends RIL implements CommandsInterface {
    ...
    public PanasonicQualcommRIL(Context context, int networkMode, int cdmaSubscription) {
